...
use Haartyhanks\AuthReview\Api\Data\EntitySearchResultsInterfaceFactory;
use Haartyhanks\AuthReview\Api\EntityRepositoryInterface;
use Haartyhanks\AuthReview\Model\ResourceModel\Entity as ResourceEntity;
use Haartyhanks\AuthReview\Model\ResourceModel\Entity\CollectionFactory as EntityCollectionFactory;
...
class EntityRepository implements EntityRepositoryInterface
{
    ...
    public function save(
        ...
        $entityData = $this->extensibleDataObjectConverter->toNestedArray(
            $entity,
            [],
            \Haartyhanks\AuthReview\Api\Data\EntityInterface::class
        );

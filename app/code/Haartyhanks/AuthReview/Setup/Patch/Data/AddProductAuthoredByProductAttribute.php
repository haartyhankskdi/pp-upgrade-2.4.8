...
class AddProductAuthoredByProductAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    {
        $attributeCode = 'product_authored_by';
        ...
        $eavSetup->addAttribute(
            ...
            [
                'type' => 'int',
                'label' => 'Product Authored By',
                'input' => 'select',
                'source' => \Haartyhanks\AuthReview\Model\Product\Attribute\Source\ProductAuthoredBy::class,
                'frontend' => '',
                'required' => false,
                'backend' => '',
                'sort_order' => '30',
    ...
    public function revert()
    {
        ...
        /** @var EavSetup $eavSetup */
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'product_authored_by');

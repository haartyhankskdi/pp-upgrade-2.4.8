...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
	    ...
	    protected function _initSelect()
		{
		    ...
		    return $this->getSelect(
		        ...
		        ['suffer_diagnosed_yes','other_medication_yes','have_allergies_yes','registered_gp','upload_documents_prescriber_yes'] 		   
		    )->joinLeft(
		    ...
		    // )->group('main_table.increment_id')->order('main_table.created_at DESC');

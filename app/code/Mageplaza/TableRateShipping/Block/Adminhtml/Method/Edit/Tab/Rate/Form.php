...
class Form extends Generic
{
    ...
    private function addCondFieldset($form)
    {
        ...
        $fieldset->addField('not_applied_countries', 'multiselect', [
            'name'   => 'not_applied_countries',
            'label'  => __('Not Applied Countries'),
            'title'  => __('Not Applied Countries'),
            'values' => $countries,
            'note'   => __('Select countries where the method should not apply.'),
        ]);

...
class SpeedOptimizer extends \Magento\Framework\View\Element\Template
{
    ...
    public function addLoading($content)
    {
        ...
        if($style){
            ...
            // Google Tag Manager
           $gtmScript = "\n<!-- Google Tag Manager  -->\n";
           $gtmScript .= "<script>(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':";
           $gtmScript .= "new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],";
           $gtmScript .= "j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src=";
           $gtmScript .= "'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);";
           $gtmScript .= "})(window,document,'script','dataLayer','GTM-NZ3HG8H');</script>";
           $gtmScript .= "\n<!-- End Google Tag Manager -->\n";
           $content = str_ireplace('</head>', $gtmScript . '</head>', $content);

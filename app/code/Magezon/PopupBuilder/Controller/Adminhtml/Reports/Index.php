...
class Index extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Popup Builder'), __('Popup Builder'));
        $resultPage->addBreadcrumb(__('Popup Reports'), __('Popup Reports'));
        $resultPage->getConfig()->getTitle()->prepend(__('Popup Reports'));
        return $resultPage;
    }
}

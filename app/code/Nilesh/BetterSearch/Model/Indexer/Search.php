...
namespace Nilesh\BetterSearch\Model\Indexer;
/*
...
class Search implements \Magento\Framework\Indexer\ActionInterface
{
        ...
        */
        ...
        foreach ($stores as $store) {
            ...
            foreach ($collection as $_product) {
                ...
                $formatPrice = $this->priceFormater->currency(number_format($_product->getPrice(),2),true,false);

    ...
    public function execute()
    {
        ...
        try {
            ...
            if($getItemNeedGQ && ($this->_cartHelper->getNeedOfGQ() == 0) && $this->_cartHelper->isLogin()){
                $resultRedirect->setUrl($this->storeManager->getStore()->getUrl("customer/general/question", array("referer"=>base64_encode($this->storeManager->getStore()->getUrl("onestepcheckout/index/index")))));
            }
            elseif($this->cartIsNotEmpty()){
                $resultRedirect->setUrl($this->storeManager->getStore()->getUrl('onestepcheckout'));
            }else{

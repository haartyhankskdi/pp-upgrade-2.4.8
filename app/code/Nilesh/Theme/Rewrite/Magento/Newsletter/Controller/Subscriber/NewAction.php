...
namespace Nilesh\Theme\Rewrite\Magento\Newsletter\Controller\Subscriber;
...
class NewAction extends SubscriberController implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        ...
        // $redirectUrl = $this->_redirect->getRedirectUrl('/newsletter-success');
        return $redirect->setUrl('/newsletter-success');
    }

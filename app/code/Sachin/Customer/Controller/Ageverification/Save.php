...
class Save extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        // Subject details
        $params->Person->forename                       = $data['firstname'];
        $params->Person->middle                         = '';
        $params->Person->surname                        = $data['lastname'];
        $params->Person->gender                         = $data['gender'];
        $params->Person->dob                            = $data['dob'];
        // $params->Person->dob                            = '';
        ...
        $params->Person->address1                       = $data['address1'];
        $params->Person->address2                       = $data['address2'];
        $params->Person->address3                       = '';
        $params->Person->address4                       = '';
        $params->Person->address5                       = '';
        $params->Person->address6                       = '';
        $params->Person->postcode                       = $data['postcode'];
        ...
        $error = $results->Summary->ResultText;
        if($error == "PASS"){
            $customer->setCustomAttribute('ageverification', "adult");   
            $this->customerRepository->save($customer);
            $this->helperData->saveCustomerAgeverify($data);
            $age = $results->Age->AgeLower;
        }else{
            $customer->setCustomAttribute('ageverification', "minor");   
            $this->customerRepository->save($customer);
            $age = "We're unable to verify your age. Please re-enter with the correct information.";
            $this->helperData->updateCustomerAgeverify($data);
            
            //$this->helperData->removeCartProduct();
            // $cart = $this->modelCart;

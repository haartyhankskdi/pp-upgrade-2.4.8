...
class Details extends Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->getConfig()->getTitle()->prepend(__('Abandoned Cart Customers Details'));
        
        $block = \Webkul\AbandonedCart\Block\Adminhtml\Customer\Cart\Details::class;
        $content = $resultPage->getLayout()->createBlock($block);
        $resultPage->addContent($content);

        $block = \Webkul\AbandonedCart\Block\Adminhtml\Customer\Cart\Details\Edit\Tabs::class;

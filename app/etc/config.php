...
return [
    'modules' => [
        ...
        'Amasty_Base' => 1,
        'Amasty_CustomFormsLiteSubscriptionPackage' => 0,
        'Amasty_Customform' => 1,
        'Amasty_CustomformGraphQl' => 0,
        'Amasty_Geoip' => 1,
        'Amasty_GdprCookie' => 1,
        ...
        'Egits_GoogleMerchantApi' => 1,
        'Fetchify_Fetchify' => 1,
        'Fooman_EmailAttachments' => 1,
        'Fooman_PrintOrderPdf' => 1,
        'Haartyhanks_AuthReview' => 1,
        'Haartyhanks_Catalog' => 0,
        'Haartyhanks_CategoryPost' => 1,
        'Haartyhanks_CategoryQuest' => 1,
        'Haartyhanks_CategoryQuestWL' => 1,
        'Haartyhanks_CustomerAttributes' => 1,
        'Haartyhanks_CustomerOrderGrid' => 1,
        'Haartyhanks_EcommerceAnalytics' => 1,
        'Haartyhanks_Htheme' => 1,
        'Haartyhanks_LNAPI' => 1,
        'Haartyhanks_LumaChild' => 1,
        'Haartyhanks_ProductPage' => 1,
        'Haartyhanks_RemoveObjectManager' => 0,
        ...
        'Kdi_GHQ' => 1,
        'Kdi_ImageUpload' => 1,
        'Kdi_JumioVerification' => 0,
        'Kdi_Login' => 1,
        'Kdi_NoIndexNofollow' => 1,
        'Kdi_Pharmacist' => 1,
        'Kdi_Phase' => 1,
        'Kdi_Popup' => 1,
        'Kdi_RemoveCart' => 0,
        ...
        'Klarna_KpGraphQl' => 1,
        'MY_BlacklistRepeat' => 1,
        'MY_Checkout' => 1,
        'MY_CustomExport' => 1,
        'MageTim_CategoryImageAltTags' => 1,
        'Magecomp_Googlelangtranslator' => 1,
        'Magefan_Community' => 1,
        'Magefan_Blog' => 1,
        'Magefan_LazyLoad' => 1,
        ...
        'Magezon_PopupBuilder' => 1,
        'Magezon_UiBuilder' => 1,
        'Magezon_UiChooserLayout' => 1,
        'Mirasvit_Core' => 1,
        'Mirasvit_Helpdesk' => 1,
        'Mirasvit_Report' => 1,
        'Nilesh_BetterSearch' => 1,
        'Nilesh_ContactDB' => 1,
        'Nilesh_GeneralQuestions' => 1,
        'Nilesh_GpManagement' => 1,
        'Nilesh_InvalidSecurityFormKeyBugFix' => 1,
        'Nilesh_Logcleaner' => 1,
        'Nilesh_MirasvitHelpdeskCustomerImage' => 1,
        'Nilesh_OrderStatus' => 1,
        'Nilesh_Prefech' => 1,
        'Nilesh_PrescriberName' => 1,
        'Nilesh_PrescriberNotes' => 1,
        'Nilesh_PrintPdf' => 1,
        'Nilesh_ProductCustomOption' => 1,
        'Nilesh_RegistrationPreference' => 1,
        'Nilesh_Reorder' => 1,
        'Nilesh_Theme' => 1,
        'PayPal_Braintree' => 1,
        ...
        'RedChamps_CustomerCartTabFix' => 1,
        'Sachin_Captcha' => 1,
        'Sachin_Customer' => 1,
        'Sachin_OrderFlag' => 1,
        'Sachin_ShippingMethod' => 1,
